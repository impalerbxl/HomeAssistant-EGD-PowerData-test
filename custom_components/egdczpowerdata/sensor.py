...
async def async_setup_platform(hass, config, async_add_entities, discovery_info=None):
    ...
    sensor_isc1 = EGDPowerDataSensor(hass, client_id, client_secret, ean, days, "ISQ2", "mdi:transmission-tower-export")
    sensor_icc1 = EGDPowerDataSensor(hass, client_id, client_secret, ean, days, "ICQ2", "mdi:transmission-tower-import")
